...
import de.vantrex.skysens.client.config.categories.server.ServerCategory;
...
public class SkysensConfig extends Config {
    ...
    @Category(name = "Server", desc = "Skysens Server (optional, opt-in)")
    @Expose
    public ServerCategory serverCategory = new ServerCategory();
